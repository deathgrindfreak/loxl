...
(test-loxl-file "operator/divide_nonnum_num" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/divide_num_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
...
(test-loxl-file "operator/greater_nonnum_num" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/greater_num_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/greater_or_equal_nonnum_num" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/greater_or_equal_num_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/less_nonnum_num" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/less_num_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/less_or_equal_nonnum_num" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/less_or_equal_num_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/multiply" :expected '("15" "3.7020001"))
(test-loxl-file "operator/multiply_nonnum_num" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/multiply_num_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/negate" :expected '("-3" "3" "-3"))
(test-loxl-file "operator/negate_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
...
(test-loxl-file "operator/subtract_nonnum_num" :expected '("[line 1] Error: Operands must be a numbers."))
(test-loxl-file "operator/subtract_num_nonnum" :expected '("[line 1] Error: Operands must be a numbers."))
